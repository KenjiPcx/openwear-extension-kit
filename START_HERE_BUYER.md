...
The source is MIT licensed. Decart's inference service and terms are separate. See `README.md`, `extension/README.md`, and `proof.md` for implementation and verification details. Automated build and tests passed on 2026-09-24. An operated Brave test on an entitled account returned live AI video and switched between two starter garments. That does not establish access for your account, arbitrary product-image fidelity, or fit accuracy; verify your own key and Lucy VTON entitlement before relying on a live demo.
